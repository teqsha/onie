...
const refresh_tokens = async () => {
    ...
    token_storage.set('access_token', response.data.access_token);
    token_storage.set('refresh_token', response.data.refresh_token);
...
// import axios from 'axios';
// import {BASE_URL, REFRESH_TOKEN} from '../redux/API';
